...
export default function Header() {
  return (
    <div className="flex justify-between items-center bg-gradient-to-t from-bgPrimary-from to-bgPrimary-to py-2 px-8 shadow-md shadow-black/40 z-50 max-md:px-4 sticky">
      <div className="">
        <Link href={"/"}>
